...
public class AppiumUtils {
...

   {
    ...
    public List<HashMap<String, String>> getJsonData(String jsonFilePath) throws IOException {
   	//System.getProperty("user.dir")+"src//test//java//org//justfordesign//testdata//eCommerce.json" 
   ...
   
   {
   	...
   	//1. capture n place in folder 2. Extent Report pick file and attach to report
   }
}
