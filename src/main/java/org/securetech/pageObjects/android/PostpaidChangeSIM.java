...
public class PostpaidChangeSIM extends AndroidActions{
	
AndroidDriver driver;

	
	public PostpaidChangeSIM(AndroidDriver driver)
	...
	@AndroidFindBy(id="com.securetech.jazzbvs:id/btnSIMChange2")
...
//	@AndroidFindBy(xpath="//android.widget.TextView[@text ='Charged']")
	...
	public void performSIMChangePostpaid()
   ...
   public void setIMSI(String IMSI)
    ...
    public void executeChangeSIMPostpaid()
